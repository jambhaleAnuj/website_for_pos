...
import featuresdiagonal from "../assets/images/project_srs.png";

export const FeaturesDiagonal = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const onButtonClick = () => {
    const pdfURL = "project_document.pdf";
        ...
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-customDarkBg1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            ...
            <p className="mb-16 text-customGrayText leading-loose">
              Download the project documentation, may also be called as the SRS
              that is the Software requirement Specification. The Documentation
              contains Use Product Scope, case Diagrams, flowcharts, Database
              table diagrams, some basic test cases performed, and many more
              things.
              <br />
              To add or remove anything from the project documentation, contact
              me at{" "}
              <span className="font-extrabold"> jambhaleanuj@gmail.com </span>
            </p>
            <div
